// import 'package:OnTheWay/Map/StoreMapScreen.dart';
// import 'package:OnTheWay/Map/s.dart';
...
//                                           onTap: () {
//                                             if (!isMyPost) {
//                                               // '가게 위치' 텍스트를 탭했을 때 실행할 기능 (내 게시물이 아닐 때만)
//
//                                             }
//                                             else{
...
//                                           onTap: () {
//                                             if (!isMyPost) {
//                                               pp();// '가게 위치' 텍스트를 탭했을 때 실행할 기능 (내 게시물이 아닐 때만)
//                                             }
//                                             else{
//                                               postManager.helpAndExit(context, doc); // 내 게시물인 경우에는 원래 게시물 눌렀을때 기능
//                                             }
