...
class PostStoreMap extends StatefulWidget {
  final String documentId;

  PostStoreMap({required this.documentId});

  @override
  _MapScreenState createState() => _MapScreenState();
}

class _MapScreenState extends State<PostStoreMap> {
  ...
  void _moveToCurrentLocation(String documentId) async {
    ...
    var storeLocation = data['store_location'];
    if (storeLocation != null) {
      ...
      if (latLngParts.length == 2) {
        ...
        setState(() {
          storeSelectedLocation = storeLatLng; // 선택된 위치 업데이트
      ...
      body: Stack(
        children: [
          KakaoMap(
            ...
            // 마커 리스트 설정
            center: storeSelectedLocation ?? LatLng(36.351041, 127.301007),
            // 초기 중심 위치 설정
