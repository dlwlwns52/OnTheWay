...
class ReportUserService extends StatefulWidget {
  final String helperEmail;
  final String targetEmail;

  ReportUserService({required this.helperEmail, required this.targetEmail});

  @override
  _ReportUserServiceState createState() => _ReportUserServiceState();
}

class _ReportUserServiceState extends State<ReportUserService> {
                          ...
                          child: Column(
                            ...
                            children: [
                              Container(
                                ...
                                child: Text(
                                  '신고 내용을 작성해 주시면, 접수 후 24시간 이내에 \n검토 결과를 이메일로 안내해 드리겠습니다.',
                  ...
                  child: ElevatedButton(
                    onPressed: () async {
                      ...
                      await firestore.collection('report')
                          .doc(widget.helperEmail)
                          .set({
                            'reportEmail': widget.targetEmail,
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => SuccessReportScreen()),
                      );
                    },
