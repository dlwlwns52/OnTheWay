...
class SuccessChatReportScreen extends StatefulWidget {

  @override
  _SuccessChatReportScreenState createState() => _SuccessChatReportScreenState();
}

class _SuccessChatReportScreenState extends State<SuccessChatReportScreen> {
  @override
